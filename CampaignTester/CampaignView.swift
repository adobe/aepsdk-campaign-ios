                ...
                VStack {
                    ...
                    Group {
                        Button(action: {
                            ...
                            let fullscreenConsequence = ["id": UUID().uuidString, "type": "iam", "assetsPath": "assets", "detail": fullscreenDetailDictionary] as [String: Any?]
...
func addTestHtmlToCache() {
    ...
    if !fileManager.fileExists(atPath: fileDirectoryPath) {
        ...
        print("File \(fileDirectory) already exists")
    }
    let fileUrl = fileDirectory.appendingPathComponent("test.html")
